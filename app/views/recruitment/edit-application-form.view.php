    ...
    <div class="main-content">
        <header class="top-header">
            <div class="header-left">
                ...
                <h1 class="page-title">Edit Application Form</h1>
            </div>
        ...
        <div class="dashboard-content">
            <div class="main-container">
                <div class="page-intro">
                    <a href="<?= ROOT ?>/recruitment/applicationforms/preview/<?= $form['id'] ?>" class="back-link">
                    ...
                    <p class="intro-text">Update form fields and settings</p>
                </div>
                ...
                <div class="job-info-card">
                    ...
                    <div class="job-info-grid">
                        <div class="info-item">
                            ...
                            <span class="info-value"><?= esc($form['job_title']) ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Department:</span>
                            <span class="info-value"><?= esc($form['department']) ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Location:</span>
                            <span class="info-value"><?= esc($form['location']) ?></span>
                        </div>
                        <div class="info-item">
                            <span class="info-label">Employment Type:</span>
                            <span class="info-value"><?= esc($form['employment_type']) ?></span>
                        </div>
                        <div class="info-item">
                ...
                <!-- Form Builder -->
                <form method="POST" action="<?= ROOT ?>/recruitment/applicationforms/update" id="formBuilderForm">
            <input type="hidden" name="form_id" value="<?= $form['id'] ?>">
            <input type="hidden" name="job_post_id" value="<?= $form['job_post_id'] ?>">
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <input type="text" id="form_title" name="form_title" class="form-control" 
                               value="<?= esc($form['form_title']) ?>" required>
                    </div>
                </div>
                <div class="form-row">
                    <div class="form-group">
                        <label for="form_description">Form Description</label>
                        <textarea id="form_description" name="form_description" class="form-control" rows="3"
                                  ><?= esc($form['form_description']) ?></textarea>
                    </div>
                </div>
            </div>
                    ...
                    <div class="field-category">
                        ...
                        <div class="fields-grid">
                            <?php foreach ($category_data['fields'] as $field): ?>
                                <?php 
                                $is_checked = isset($selected_fields[$category]) && in_array($field['name'], $selected_fields[$category]);
                                ?>
                                <div class="field-checkbox-item">
                                    <input type="checkbox" 
                                           ...
                                           value="<?= $field['name'] ?>"
                                           <?= $field['required'] || $is_checked ? 'checked' : '' ?>
            ...
            <div class="form-actions">
                <a href="<?= ROOT ?>/recruitment/applicationforms/preview/<?= $form['id'] ?>" class="btn btn-secondary">Cancel</a>
