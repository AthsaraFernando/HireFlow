...
<body>
    ...
    <div class="security-container">
        <div class="page-header">
            ...
            <p>Configure system security policies and monitor security events</p>
        </div>
            ...
            <div class="security-grid">
                <div class="security-card <?= $security_settings['brute_force_protection'] ? 'enabled' : 'disabled' ?>">
                    <div class="card-header">
                        ...
                        <span class="security-status <?= $security_settings['brute_force_protection'] ? 'status-enabled' : 'status-disabled' ?>">
                ...
                <div class="security-card <?= $security_settings['two_factor_auth'] ? 'enabled' : 'warning' ?>">
                    <div class="card-header">
                        ...
                        <span class="security-status <?= $security_settings['two_factor_auth'] ? 'status-enabled' : 'status-warning' ?>">
                ...
                <div class="security-card <?= $security_settings['ssl_required'] ? 'enabled' : 'warning' ?>">
                    <div class="card-header">
                        ...
                        <span class="security-status <?= $security_settings['ssl_required'] ? 'status-enabled' : 'status-warning' ?>">
            ...
            <form method="POST" action="<?= ROOT ?>/systemadmin/security-settings">
                ...
                <div class="mt-3">
                    <label class="form-label">
                        <input type="checkbox" <?= $security_settings['email_verification'] ? 'checked' : '' ?> name="email_verification"> 
                ...
                <div class="mt-3">
                    <label class="form-label">
                        <input type="checkbox" <?= $security_settings['session_security'] ? 'checked' : '' ?> name="session_security"> 
        ...
        <div class="security-section">
            ...
            <div id="ipWhitelistSection" style="<?= $security_settings['ip_whitelist_enabled'] ? '' : 'display:none' ?>">
                ...
                <div class="alert alert-warning mt-2">
                    <strong>Warning:</strong> Your current IP (192.168.1.50) will be automatically added to prevent lockout.
                </div>
            ...
            <table class="security-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="security-status <?= $login['status'] === 'Blocked' ? 'status-disabled' : ($login['status'] === 'Monitoring' ? 'status-warning' : 'status-enabled') ?>">
                                <?= $login['status'] ?>
                            </span>
                        </td>
                        <td>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <?php else: ?>
                                <button class="btn btn-sm btn-outline-danger" onclick="terminateSession('<?= $session['user'] ?>')">
                                    Terminate
                                </button>
                            <?php endif; ?>
                        </td>
