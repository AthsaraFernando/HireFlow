    ...
    <div class="dashboard-content">
        <div class="main-container">
            ...
            <div class="form-container" style="background:#fff; border-radius:12px; padding:1.5rem;">
                <form method="POST" action="<?= ROOT ?>/hradmin/departments/create">
                    ...
                    <div class="form-group" style="margin-bottom:1rem;">
                        ...
                        <textarea name="description" class="form-textarea" rows="4"><?= htmlspecialchars($form_data['description'] ?? '') ?></textarea>
                    </div>
                    ...
                    <div class="form-group" style="margin-bottom:1rem;">
                        ...
                        <select name="head_of_department" class="form-select">
                            ...
                            <?php foreach (($managers ?? []) as $manager): ?>
                                <option value="<?= $manager['id'] ?>" <?= (string)($form_data['head_of_department'] ?? '') === (string)$manager['id'] ? 'selected' : '' ?>>
